...
## Build
1) Create build folder inside `\VisualAlgorithms\`.
2) Set _QT_5_PATH option. (like:`cmake .. -D_QT_5_PATH="C:\Qt\5.15.2\msvc2019_64`")
...
cmake --build .
```
Executables will be inside Debug folder in current project. 
